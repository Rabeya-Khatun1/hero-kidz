"use client"
import { postUsers } from '@/api/auth';
...
const handleSubmit = async (e)=>{
    ...
    return (
          ...
          <input name="name" type="text" className="input" placeholder="Name" value={form.name} onChange={handleChange} />
          <label className="label">Email</label>
          <input name="email" type="email" className="input" placeholder="Email" value={form.email} onChange={handleChange} />
          <label className="label">Password</label>
          <input name="password" type="password" className="input" placeholder="Password" value={form.password} onChange={handleChange} />
          <div><a className="link link-hover">Forgot password?</a></div>
          <button className="btn btn-primary text-white mt-4" onClick={handleSubmit}>Sign up</button>
        {/* Google */}
